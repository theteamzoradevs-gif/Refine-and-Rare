...
export function ServiceFlipCard({
  ...
  return (
    ...
    >
      ...
      >
        {/* Front */}
        <div className="flip-face overflow-hidden border border-line/60 shadow-[0_20px_50px_-28px_rgba(28,36,33,0.55)]">
          <Image
          ...
          <div className="pointer-events-none absolute inset-0 opacity-0 transition duration-500 [background:linear-gradient(120deg,transparent_30%,rgba(197,178,138,0.22)_50%,transparent_70%)] hover:opacity-100" />
        </div>

        {/* Back */}
        <div className="flip-face flip-face-back flex flex-col justify-between border border-gold/30 bg-ink p-6 text-cream shadow-[0_20px_50px_-28px_rgba(28,36,33,0.7)]">
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-gold">
              Service
            </p>
